...
$(function(){
    $("<script/>", {
      ...
      src: "https://maps.google.com/maps/api/js?key=AIzaSyDfeSc7kRuhm_txbcXq74HZ1YdMvvy9m9M&v=3.2&sensor=false&language=th&callback=initialize"
    }).appendTo("body");    
});
</script>  
